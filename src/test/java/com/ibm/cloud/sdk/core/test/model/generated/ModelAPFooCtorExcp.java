 ...
 */
public class ModelAPFooCtorExcp extends DynamicModel<Foo> {
  @SerializedName(value="prop1", alternate={"property1", "p1"})
  private String prop1;
  @SerializedName(value="prop2", alternate={"property2", "p2"})
  private Long prop2;

  public ModelAPFooCtorExcp() {
    super(new TypeToken<Foo>(){});
    throw new NullPointerException("Simulating an NPE to trigger a deserialization exception!");
  }
