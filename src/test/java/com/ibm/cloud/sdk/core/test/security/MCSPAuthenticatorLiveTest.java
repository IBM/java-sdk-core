...
//
// This class contains an integration test that uses the live MCSP token service.
// This test is normally @Ignored to avoid trying to run this during automated builds.
//
// In order to run these tests, create file "mcsptest.env" in the project root.
// It should look like this:
//
// MCSPTEST1_AUTH_URL=<token server's base url>   e.g. https://iam.platform.test.saas.ibm.com
// MCSPTEST1_AUTH_TYPE=mcsp
// MCSPTEST1_APIKEY=<apikey>
//
// Then remove/comment-out the @Ignore annotation below and run the method as a TestNG test.
//
public class MCSPAuthenticatorLiveTest {

  @Ignore
  @Test
  public void testMCSPLiveTokenServer() {
    System.setProperty("IBM_CREDENTIALS_FILE", "mcsptest.env");

    Authenticator auth1 = ConfigBasedAuthenticatorFactory.getAuthenticator("mcsptest1");
    assertNotNull(auth1);
