 ...
 */
package com.ibm.openapi.sdk.core.service;

import com.google.gson.JsonObject;
import com.ibm.openapi.sdk.core.http.HttpClientSingleton;
import com.ibm.openapi.sdk.core.http.HttpConfigOptions;
import com.ibm.openapi.sdk.core.http.HttpHeaders;
import com.ibm.openapi.sdk.core.http.HttpMediaType;
import com.ibm.openapi.sdk.core.http.HttpStatus;
import com.ibm.openapi.sdk.core.http.RequestBuilder;
import com.ibm.openapi.sdk.core.http.ResponseConverter;
import com.ibm.openapi.sdk.core.http.ServiceCall;
import com.ibm.openapi.sdk.core.http.ServiceCallback;
import com.ibm.openapi.sdk.core.http.ServiceCallbackWithDetails;
import com.ibm.openapi.sdk.core.service.exception.BadRequestException;
import com.ibm.openapi.sdk.core.service.exception.ConflictException;
import com.ibm.openapi.sdk.core.service.exception.ForbiddenException;
import com.ibm.openapi.sdk.core.service.exception.InternalServerErrorException;
import com.ibm.openapi.sdk.core.service.exception.NotFoundException;
import com.ibm.openapi.sdk.core.service.exception.RequestTooLargeException;
import com.ibm.openapi.sdk.core.service.exception.ServiceResponseException;
import com.ibm.openapi.sdk.core.service.exception.ServiceUnavailableException;
import com.ibm.openapi.sdk.core.service.exception.TooManyRequestsException;
import com.ibm.openapi.sdk.core.service.exception.UnauthorizedException;
import com.ibm.openapi.sdk.core.service.exception.UnsupportedException;
import com.ibm.openapi.sdk.core.service.security.IamOptions;
import com.ibm.openapi.sdk.core.service.security.IamTokenManager;
import com.ibm.openapi.sdk.core.util.CredentialUtils;
import com.ibm.openapi.sdk.core.util.RequestUtils;
import com.ibm.openapi.sdk.core.util.ResponseConverterUtils;
import com.ibm.openapi.sdk.core.util.ResponseUtils;
...
public abstract class WatsonService {
  ...
  class WatsonServiceCall<T> implements ServiceCall<T> {
    ...
    @Override
    public com.ibm.openapi.sdk.core.http.Response<T> executeWithDetails() throws RuntimeException {
      try {
        Response httpResponse = call.execute();
        T responseModel = processServiceCall(converter, httpResponse);
        return new com.ibm.openapi.sdk.core.http.Response<>(responseModel, httpResponse);
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
    }
      ...
      call.enqueue(new Callback() {
        ...
        public void onResponse(Call call, Response response) {
          try {
            ...
            callback.onResponse(new com.ibm.openapi.sdk.core.http.Response<>(responseModel, response));
          } catch (Exception e) {
            callback.onFailure(e);
          }
        }
    ...
    @Override
    public CompletableFuture<com.ibm.openapi.sdk.core.http.Response<T>> rxWithDetails() {
      final CompletableFuture<com.ibm.openapi.sdk.core.http.Response<T>> completableFuture
      ...
      call.enqueue(new Callback() {
        ...
        public void onResponse(Call call, Response response) {
          try {
            T responseModel = processServiceCall(converter, response);
            completableFuture.complete(new com.ibm.openapi.sdk.core.http.Response<>(responseModel, response));
          } catch (Exception e) {
            completableFuture.completeExceptionally(e);
          }
        }
