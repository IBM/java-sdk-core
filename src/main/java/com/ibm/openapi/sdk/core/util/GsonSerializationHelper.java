package com.ibm.openapi.sdk.core.util;

import java.lang.reflect.Type;

/**
 * Utility class to help with serialization in models which extend
 * {@link com.ibm.openapi.sdk.core.service.model.DynamicModel}.
 *
 * @see com.ibm.openapi.sdk.core.service.model.DynamicModel
 */
public class GsonSerializationHelper {
  ...
  /**
   * Takes a property of an object extending {@link com.ibm.openapi.sdk.core.service.model.DynamicModel} and
   * serializes it to the desired type. Without this conversion, properties which also happen to
   * extend {@link com.ibm.openapi.sdk.core.service.model.DynamicModel} throw an exception when
